...
ok($err eq "Seqant accepts only tab delimited files. Please reformat your file", "Seqant requires tab delimited files");
...
ok(!defined $err, "Seqant annotates tab delimited files, even if they are wholly empty besides header");
# system('rm test.snp');
done_testing();